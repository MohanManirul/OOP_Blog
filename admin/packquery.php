        ...
        <div class="grid_10">
            ...
            <div class="box round first grid">
                <h2>Add New Package Query</h2>
                    ...
                    $query = "INSERT INTO query_package(fname,lname,mobile,email,ptitle,cat,pacdetails,author,ref,mycomm) 
                    VALUES('$fname','$lname','$mobile','$email','$ptitle','$cat','$pacdetails','$author','$ref','$mycomm')";
                        $inserted_rows = $db->insert($query);
                         if ($inserted_rows) {
                          echo "<span class='success'>Package Sent Successfully To Query Box.</span>";
